...
const UpdateProduct = ({ updateProd }) => {
    ...
    return (
        <div >
          ...
          <h1 className='adding-product' style={{marginLeft:"150px"}}>UPDATE</h1>
                    ...
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        ...
                        <Form.Control type="text" placeholder='Quantity' value={promo} onChange={(e) => setPromo(e.target.value)} />
                    </Form.Group>
